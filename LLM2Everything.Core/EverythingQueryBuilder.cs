...
{
    public string Build(SearchIntent intent, IReadOnlyList<FileTypeDefinition> fileTypes, bool includeDateFilters = true, bool includeSizeFilters = true)
    {
